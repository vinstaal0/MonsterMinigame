...
function GO ()
{
	...
	// New music!
	g_rgSoundCache.musicB = {urlv: g_AssetsHost + '/MonsterMinigame/assets/sfx/backgroundtrack2.ogg', urlm: g_AssetsHost + '/MonsterMinigame/assets/sfx/backgroundtrack2.mp3' };
